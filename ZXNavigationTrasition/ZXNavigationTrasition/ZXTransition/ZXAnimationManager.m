...
@interface ZXAnimationManager() <CAAnimationDelegate>
...
@implementation ZXAnimationManager
...
- (CGFloat)zx_animateDuration {
	return self.isPush ? self.toDuration : self.backDuration;
}
